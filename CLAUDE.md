...
- **原創致敬基準(2026-07-22 重新明文化;先前版本叫「不使用原遊戲素材、原文或精確數值」,語氣太硬,改成更明確的界線)**:
  - **方向**:視覺可受原作啟發(`docs/EVIL-HUNTER-VILLAGE-DESIGN-RESEARCH.md` §一/二/三/四/五/七/十 中可借鑑的機制與 §四 的分區原則),配色可以朝原作氣質靠近但不直接抽色票。
  - **不動 byte**:一切圖檔、音檔、動畫、字串、數值、技能樹、解鎖等級、UI 排版 — 全部原創自寫,**0 byte 原作素材進 repo**。
  - **命名**:建築、怪物、技能、地點、菜單、提示文案 — 全部原創。不可照搬原作文字或近音變體。
  - **分區原則可借,具體網格不可抄**:即使 research doc §四 或 §十 給出具體 3×5 街區或主幹道位置,實作時只能借「分圈/路網/服務區優先順序」這層抽象,**不能逐格照搬那張 ASCII 圖的格子位置與名稱組合**。
  - **對外聲明**:本專案是致敬原作的同人作品 — **非商業、非移植、不抄素材**;若日後公開上線,需有對原作的明示致敬與各素材 100% 自製的揭露。
