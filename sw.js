...
const CACHE_NAME = 'hunter-village-v27';   // bump to v27 — §十 第三 區域綁建築升級(boss → trophy → decoration)
...
const SRC_GLOB = [
  ...
  './src/building-stages.js', './src/building-effects.js', './src/reachability.js', './src/queue-points.js', './src/region-unlocks.js',
